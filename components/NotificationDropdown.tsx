...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({
    ...
    return (
        <div className="absolute top-16 left-4 right-4 sm:left-auto sm:right-0 w-auto sm:w-96 glass-elevated rounded-3xl border border-hama-gold/20 shadow-2xl z-[100] animate-in fade-in slide-in-from-top-4 duration-300 overflow-hidden backdrop-blur-3xl bg-bg-primary/90">
